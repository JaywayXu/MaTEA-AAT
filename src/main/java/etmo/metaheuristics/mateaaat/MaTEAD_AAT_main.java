...
public class MaTEAD_AAT_main {
	...
	public static MtoAlgorithm algorithmGenerate(ProblemSet problemSet) throws JMException {
		...
		algorithm.setInputParameter("normalStep", 3);
		algorithm.setInputParameter("extraStep", 3);
		algorithm.setInputParameter("initTransferP", 1.0);
